        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
          ...
          >
            {[
              ...
              >
                <div className="text-2xl font-light text-amber-500 mb-2">{stat.value}</div>
        ...
        <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="flex justify-center items-center space-x-12">
              {[
                ...
                <div key={i} className="flex items-center space-x-3">
                  ...
                  <div className="text-xs text-stone-300 tracking-[0.2em] font-medium">
                    {item.text}
                  </div>
                </div>
              ))}
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-stone-600 text-lg font-light max-w-2xl mx-auto leading-relaxed">
              Comprehensive manufacturing solutions backed by decades of engineering expertise and
          ...
          <div className="space-y-24">
            {[
              ...
              },
              {
                ...
                highlight: "Sister Concern → Hydrominds Automation",
                industries: [
                  "Cement Plants",
                  "Textile Industries",
                  "Packaging Industry",
              ...
              >
                ...
                <div className={`space-y-6 ${i % 2 === 1 ? 'lg:col-start-1 lg:row-start-1' : ''}`}>
                  ...
                  <p className="text-stone-600 text-lg font-light leading-relaxed">{service.desc}</p>
                    ...
                    {service.industries ? (
                      <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 gap-2">
                          {service.industries.map((industry, idx) => (
                            <div
                              key={idx}
                              className="flex items-start space-x-3 group hover:text-amber-600 transition-colors duration-300"
                            >
                              ...
                              <span className="text-sm text-stone-600 font-medium group-hover:text-amber-600 transition-colors duration-300 leading-relaxed">
                                {industry}
                              </span>
                            </div>
                          ))}
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        {service.features.map((feature, idx) => (
                          <div
                            key={idx}
                            className="flex items-center space-x-2 group hover:text-amber-600 transition-colors duration-300"
                          >
                            <div className="w-1.5 h-1.5 bg-amber-600 rounded-full group-hover:scale-150 transition-transform duration-300"></div>
                            <span className="text-sm text-stone-600 font-medium group-hover:text-amber-600 transition-colors duration-300">
                              {feature}
                            </span>
                          </div>
                        ))}
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="space-y-12">
            ...
            <p className="text-xl text-stone-600 font-light leading-relaxed max-w-3xl mx-auto">
              At Paresh Enterprise, we combine traditional craftsmanship with modern technology to
              deliver manufacturing solutions that exceed expectations. Our commitment to quality,
